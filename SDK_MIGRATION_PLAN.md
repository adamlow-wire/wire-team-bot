...
1. Apps feature on for the team, and who's team admin?
2. Deployment host arch confirmed x86_64?
3. Anyone need `STORAGE_DIR` to keep working? (If yes: `process.chdir()` before `create()`.)
