...
The current local image is `wire-team-bot:v3-rc-82fe04b`. See [PLAN.md](PLAN.md#candidate-disposition--2026-09-16)
...
docker run --rm --network host --user "$(id -u):$(id -g)" \
  ...
  --entrypoint node wire-team-bot:v3-rc-82fe04b \
